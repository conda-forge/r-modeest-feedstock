About r-modeest-feedstock
=========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-modeest-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=1370&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-modeest-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-modeest` can be installed with `conda`:
...
```
mamba install r-modeest
```

It is possible to list all of the versions of `r-modeest` available on your platform with `conda`:
...
```
mamba search r-modeest --channel conda-forge
```
...
mamba repoquery search r-modeest --channel conda-forge

# List packages depending on `r-modeest`:
mamba repoquery whoneeds r-modeest --channel conda-forge

# List dependencies of `r-modeest`:
mamba repoquery depends r-modeest --channel conda-forge
```
